...
@property (strong, nonatomic) IBOutlet UIBarButtonItem *themebarButton;
@property (strong, nonatomic) IBOutlet CPTGraphHostingView *hostView;
@property (strong, nonatomic) IBOutlet CPTTheme *selectedTheme;
...
@synthesize themebarButton =  _themebarButton;
...
- (IBAction)themeButtonTapped:(id)sender {
